...
For group 4, the scoring works as follows. Assume that your program needs $M$ rounds in the worst case.

If $M \geq 1000$, you will get $0$ points. Otherwise, you will score
\[ 65 \cdot \min \{ 1, \frac{1000-M}{1000-420} \} \]
points on the group. In other words, your score increases linearly as the number of rounds decreases from $1000$ to $420$.
If you never use more than $420$ rounds, you will get 65 points on group 4.
