...
\begin{tabular}{|l|l|l|}
  ...
  1 & 9 & $N \le 10, P = 2$ \\ \hline
	2 & 19 & $1 \le P \le N \le 1\,000$, $C[i] > 0$ \\ \hline
	3 & 34 & $1 \le P \le N \le 1\,000$, only cities $i$ and $i + 1$ have roads (for $0 \le i < N - 1$). \\ \hline
  4 & 38 & $1 \le P \le N \le 1\,000$ \\ \hline
	5 & 38 & $1 \le P \le N \le 100\,000$, $C[i] > 0$ \\ \hline
  6 & 38 & $1 \le P \le N \le 100\,000$ \\ \hline
\end{tabular}
...
The sample judge will first write a single line with the return value of \texttt{paths(N, K, F, T)} and the number of calls to \texttt{part(S, R)}. Then, once for each call to \texttt{part(S, R)}, the judge will write one line with $S$ and then one line with the $S$ values in $R$.
