...
\section*{Input}
Den första raden i indatan innehåller ett heltal $1 \le N \le 100\,000$, antalet regler i brandväggen.

De nästa $N$ raderna innehåller reglerna i listan, en regel per rad.

Nästa rad innehåller ett heltal $P$, antalet paket som kommer in till brandväggen. De är givna i ordningen de kom in.
