...
group fivecat 29 # M <= 5
include_group onecat
tc sample01
tc sample02
...
group samescore 20 # all questions have the same score
...
group full 35
include_group fivecat
include_group samescore
